...
class CaptioningRNN:
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(max_length):
          vector, _ = word_embedding_forward(word, W_embed)
  
          if self.cell_type == 'rnn':
            h0,_ = rnn_step_forward(vector.reshape(N,-1), h0, Wx, Wh, b)
          if self.cell_type == 'lstm':
            h0,c,_ = lstm_step_forward(vector.reshape(N,-1), h0, c, Wx, Wh, b)

          score, _ = affine_forward(h0, W_vocab, b_vocab)
